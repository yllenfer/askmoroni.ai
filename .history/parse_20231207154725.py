...
def parse_book_of_mormon(text):
    # Adjusted to match "Book Name Chapter Number"
    chapter_pattern = re.compile(r'^\w+ Chapter \d+$', re.MULTILINE)
    verse_pattern = re.compile(r'^\d+:\d+')  # Verse numbers like "1:1"
    book = {}
    ...
    for line in text.split('\n'):
        ...
        elif current_chapter and verse_pattern.match(line.strip().split(' ')[0]):
